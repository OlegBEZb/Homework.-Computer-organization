...
volatile uint8_t countLeadingZeros( uint32_t n)
{
	...
	(numerals-((n&1<<4)==(1<<4))*(numerals>>28))&(numerals-((n&1<<5)==(1<<5))*(numerals>>27))&
	(numerals-((n&1<<6)==(1<<6))*(numerals>>26))&(numerals-((n&1<<7)==(1<<7))*(numerals>>25))&
	(numerals-((n&1<<8)==(1<<8))*(numerals>>24))&(numerals-((n&1<<9)==(1<<9))*(numerals>>23))&
	(numerals-((n&1<<10)==(1<<10))*(numerals>>22))&(numerals-((n&1<<11)==(1<<11))*(numerals>>21))&
	(numerals-((n&1<<12)==(1<<12))*(numerals>>20))&(numerals-((n&1<<13)==(1<<13))*(numerals>>19))&
	(numerals-((n&1<<14)==(1<<14))*(numerals>>18))&(numerals-((n&1<<15)==(1<<15))*(numerals>>17))&
	(numerals-((n&1<<16)==(1<<16))*(numerals>>16))&(numerals-((n&1<<17)==(1<<17))*(numerals>>15))&
	(numerals-((n&1<<18)==(1<<18))*(numerals>>14))&(numerals-((n&1<<19)==(1<<19))*(numerals>>13))&
	(numerals-((n&1<<20)==(1<<20))*(numerals>>12))&(numerals-((n&1<<21)==(1<<21))*(numerals>>11))&
	(numerals-((n&1<<22)==(1<<22))*(numerals>>10))&(numerals-((n&1<<23)==(1<<23))*(numerals>>9))&
